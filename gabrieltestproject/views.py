...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gabrieltestprojects:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("gabrieltestprojects:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gabrieltestprojects:users")
...
def delete_user_view(request, pk):
    ...
    user.delete()
    return redirect("gabrieltestprojects:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gabrieltestprojects:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("gabrieltestprojects:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("gabrieltestprojects:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("gabrieltestprojects:sheppingcarts")
